#!/usr/bin/env python3
"""
This module contains a function that performs back propagation over a convolutional layer of a neural network
"""
...
def conv_backward(dZ, A_prev, W, b, padding="same", stride=(1, 1)):
    ...
    Returns:
    The partial derivatives with respect to the previous layer (dA_prev), the kernels (dW), and the biases (db), respectively
    """

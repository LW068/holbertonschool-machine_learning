...
def inception_network():
    ...
    conv1 = K.layers.Conv2D(64, 7, strides=2, padding='same',
                            activation='relu')(input_layer)
    pool1 = K.layers.MaxPooling2D(pool_size=3, strides=2,
                                  padding='same')(conv1)
    conv2 = K.layers.Conv2D(64, 1, activation='relu')(pool1)
    conv3 = K.layers.Conv2D(192, 3, padding='same',
    ...
    pool10 = K.layers.MaxPooling2D(pool_size=3, strides=2,
